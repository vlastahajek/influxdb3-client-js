...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.android-arm64.node'));
        try {
          if (localFileExisted) {
        ...
        break;
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.android-arm-eabi.node'));
        try {
          if (localFileExisted) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.win32-x64-msvc.node'));
        try {
          if (localFileExisted) {
        ...
        break;
      case 'ia32':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.win32-ia32-msvc.node'));
        try {
          if (localFileExisted) {
        ...
        break;
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.win32-arm64-msvc.node'));
        try {
          if (localFileExisted) {
    ...
    break;
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.darwin-universal.node'));
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.darwin-x64.node'));
        try {
          if (localFileExisted) {
        ...
        break;
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.darwin-arm64.node'));
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.freebsd-x64.node'));
    try {
      if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-x64-musl.node'));
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-x64-gnu.node'));
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-arm64-musl.node'));
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-arm64-gnu.node'));
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-arm-musleabihf.node'));
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-arm-gnueabihf.node'));
          try {
            if (localFileExisted) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-riscv64-musl.node'));
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-riscv64-gnu.node'));
          try {
            if (localFileExisted) {
        ...
        break;
      case 's390x':
        localFileExisted = existsSync(join(__dirname, 'influxdb3-js-flight-sql-client.linux-s390x-gnu.node'));
        try {
          if (localFileExisted) {
